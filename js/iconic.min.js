!function (a) {
    ...
    return function b(a, c, d) {
        ...
        1: [function (a, b) {
            var c = (a("./modules/polyfills"), a("./modules/svg-injector")), d = a("./modules/extend"),
                e = a("./modules/responsive"), f = a("./modules/position"), g = a("./modules/container"),
                h = a("./modules/log"), i = {}, j = window.iconicSmartIconApis = {},
                k = ("file:" === window.location.protocol, 0), l = function (a, b, e) {
                    b = d({}, i, b || {});
                    ...
                    f.each = function (a) {
                        if (a) if ("string" == typeof a) h.debug(a); else if (a instanceof SVGSVGElement) {
                            ...
                            var f = /iconic-bg-/;
                            f.test(a.getAttribute("class")) && g.addBackground(a), m(a), k++, b && b.each && "function" == typeof b.each && b.each(a)
                        }
            ...
            var c = function (a) {
                var b = a.getAttribute("class").split(" "), c = -1 !== b.indexOf("iconic-fluid"), d = [],
                    e = ["iconic-bg"];
                ...
                var f = a.parentNode, g = Array.prototype.indexOf.call(f.childNodes, a),
            ...
            Array.prototype.forEach || (Array.prototype.forEach = function (a, b) {
                ...
                if (Event.prototype.preventDefault || (Event.prototype.preventDefault = function () {
                    ...
                    var a = [], b = function (b, c) {
                        ...
                        } else this.attachEvent("on" + b, e), a.push({object: this, type: b, listener: c, wrapper: e})
                    }, c = function (b, c) {
            ...
            var c = function (a) {
                ...
                if (b && "" !== b) {
                    var c, d, e, f, g, h, i, j = a.getAttribute("width"), k = a.getAttribute("height"),
                        l = b.split("-"), m = a.querySelectorAll("g.iconic-container");
            ...
            var c = /(iconic-sm\b|iconic-md\b|iconic-lg\b)/, d = function (a, b) {
                ...
                var c = parseFloat(d(a, "width").slice(0, -2)), e = parseFloat(d(a, "height").slice(0, -2));
                ...
                if (/iconic-fluid/.test(a.getAttribute("class"))) {
                    var b, d = e(a), f = a.viewBox.baseVal.width / a.viewBox.baseVal.height;
                    b = 1 === f ? Math.min(d.width, d.height) : 1 > f ? d.width : d.height;
                    var g;
                    g = 32 > b ? "iconic-sm" : b >= 32 && 128 > b ? "iconic-md" : "iconic-lg";
                    var h = a.getAttribute("class"), i = c.test(h) ? h.replace(c, g) : h + " " + g;
                    ...
                    i = Array.prototype.forEach || function (a, b) {
                        ...
                        if (void 0 !== j[a]) j[a] instanceof SVGSVGElement ? c(o(j[a])) : p(a, c); else {
                            ...
                            d.onreadystatechange = function () {
                                if (4 === d.readyState) {
                                    ...
                                    if (d.responseXML instanceof Document) j[a] = d.responseXML.documentElement; else if (DOMParser && DOMParser instanceof Function) {
                                        var b;
                                        try {
                                            var e = new DOMParser;
                        ...
                        -1 === l.indexOf(a) && (l.push(a), a.setAttribute("src", ""), r(g, function (d) {
                            ...
                            Object.keys(v).forEach(function (a) {
                                q = a, s = v[a], r = d.querySelectorAll("defs " + q + "[id]");
                                for (var b = 0, c = r.length; c > b; b++) {
                                    t = r[b].id, u = t + "-" + k;
                                    var e;
                                    i.call(s, function (a) {
                                        e = d.querySelectorAll("[" + a + '*="' + t + '"]');
                                        for (var b = 0, c = e.length; c > b; b++) e[b].setAttribute(a, "url(#" + u + ")")
                                    }), r[b].id = u
                                }
                            }), d.removeAttribute("xmlns:a");
                            for (var w, x, y = d.querySelectorAll("script"), z = [], A = 0, B = y.length; B > A; A++) x = y[A].getAttribute("type"), x && "application/ecmascript" !== x && "application/javascript" !== x || (w = y[A].innerText || y[A].textContent, z.push(w), d.removeChild(y[A]));
                            if (z.length > 0 && ("always" === c || "once" === c && !n[g])) {
                                for (var C = 0, D = z.length; D > C; C++) new Function(z[C])(b);
                                n[g] = !0
                            }
                            var E = d.querySelectorAll("style");
                            i.call(E, function (a) {
                                a.textContent += ""
                        ...
                        b = b || {};
                        var d = b.evalScripts || "always", e = b.pngFallback || !1, f = b.each;
                        if (void 0 !== a.length) {
                            var g = 0;
                            i.call(a, function (b) {
                                s(b, d, e, function (b) {
